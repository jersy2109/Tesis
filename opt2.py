...
def training(env_name, replay_memory_size=200_000, max_frames=50_000_000, gamma=0.99, batch_size=32,  \
...
if __name__ == '__main__':
    import sys
    training(env_name=sys.argv[1]+'NoFrameskip-v4', verbose=True)